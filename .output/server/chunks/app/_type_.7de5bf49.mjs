...
const _sfc_main = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  ...
  async setup(__props) {
    ...
    const AllPostId = ([__temp, __restore] = vue_cjs_prod.withAsyncContext(() => useAsyncData("AllPostId", () => getAllPostIds(), "$ZxfZhxL1OA")), __temp = await __temp, __restore(), __temp);
...
const _type_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-54d82458"]]);

export { _type_ as default };
//# sourceMappingURL=_type_.7de5bf49.mjs.map
