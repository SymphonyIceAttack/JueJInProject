...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = vue_cjs_prod.defineAsyncComponent(() => import('./error-404.33ca5c7a.mjs'));
    const _Error = vue_cjs_prod.defineAsyncComponent(() => import('./error-500.ed6f6fa0.mjs'));
...
//# sourceMappingURL=error-component.1f4cf91e.mjs.map
