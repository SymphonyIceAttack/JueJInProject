...
const _sfc_main = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  ...
  async setup(__props) {
    ...
    }, "$ujNGItQjjI")), __temp = await __temp, __restore(), __temp);
...
const _id_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-7cb4a095"]]);

export { _id_ as default };
//# sourceMappingURL=_id_.1c662ba0.mjs.map
