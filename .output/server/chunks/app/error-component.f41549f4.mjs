...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = vue_cjs_prod.defineAsyncComponent(() => import('./error-404.9592344b.mjs'));
    const _Error = vue_cjs_prod.defineAsyncComponent(() => import('./error-500.1906e70a.mjs'));
...
//# sourceMappingURL=error-component.f41549f4.mjs.map
