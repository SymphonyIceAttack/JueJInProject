...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = vue_cjs_prod.defineAsyncComponent(() => import('./error-404.e191ca09.mjs'));
    const _Error = vue_cjs_prod.defineAsyncComponent(() => import('./error-500.0081daa7.mjs'));
...
//# sourceMappingURL=error-component.d7a8949b.mjs.map
