...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = vue_cjs_prod.defineAsyncComponent(() => import('./error-404.c0e0de8a.mjs'));
    const _Error = vue_cjs_prod.defineAsyncComponent(() => import('./error-500.ac397275.mjs'));
...
//# sourceMappingURL=error-component.00ded7ef.mjs.map
