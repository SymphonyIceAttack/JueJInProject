...
const _sfc_main = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  ...
  async setup(__props) {
    ...
    }, "$SB6ENenb6i")), __temp = await __temp, __restore(), __temp);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-0d0879ce"]]);

export { index as default };
//# sourceMappingURL=index.35307bc6.mjs.map
