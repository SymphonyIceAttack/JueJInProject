...
const _sfc_main = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  ...
  async setup(__props) {
    ...
    }, "$pONWCiUbSx")), __temp = await __temp, __restore(), __temp);
...
const _type_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-3bec5ee4"]]);

export { _type_ as default };
//# sourceMappingURL=_type_.b8ff4616.mjs.map
