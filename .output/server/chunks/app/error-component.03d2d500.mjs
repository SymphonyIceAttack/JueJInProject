...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = vue_cjs_prod.defineAsyncComponent(() => import('./error-404.e3464abc.mjs'));
    const _Error = vue_cjs_prod.defineAsyncComponent(() => import('./error-500.efea7d47.mjs'));
...
//# sourceMappingURL=error-component.03d2d500.mjs.map
