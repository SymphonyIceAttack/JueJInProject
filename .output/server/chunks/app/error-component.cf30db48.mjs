...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = vue_cjs_prod.defineAsyncComponent(() => import('./error-404.5e8829ba.mjs'));
    const _Error = vue_cjs_prod.defineAsyncComponent(() => import('./error-500.d748e2b4.mjs'));
...
//# sourceMappingURL=error-component.cf30db48.mjs.map
