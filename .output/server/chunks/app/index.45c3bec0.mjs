...
const _sfc_main = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  ...
  async setup(__props) {
    ...
    }, "$UMHXXijeG9")), __temp = await __temp, __restore(), __temp);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-75fc5f6e"]]);

export { index as default };
//# sourceMappingURL=index.45c3bec0.mjs.map
