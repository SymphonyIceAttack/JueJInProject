...
const _sfc_main = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  ...
  async setup(__props) {
    ...
    }, "$3lnJJqr4AT")), __temp = await __temp, __restore(), __temp);
...
const _id_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-2fe093d8"]]);

export { _id_ as default };
//# sourceMappingURL=_id_.58201f0c.mjs.map
