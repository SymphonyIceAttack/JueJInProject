...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = vue_cjs_prod.defineAsyncComponent(() => import('./error-404.7dd58837.mjs'));
    const _Error = vue_cjs_prod.defineAsyncComponent(() => import('./error-500.0626ba71.mjs'));
...
//# sourceMappingURL=error-component.45d99220.mjs.map
