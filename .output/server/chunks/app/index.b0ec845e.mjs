...
const _sfc_main = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  ...
  async setup(__props) {
    ...
    const AllPostId = ([__temp, __restore] = vue_cjs_prod.withAsyncContext(() => useAsyncData("AllPostId", () => getAllPostIds(), "$RefMhvisUz")), __temp = await __temp, __restore(), __temp);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-7ffa24b4"]]);

export { index as default };
//# sourceMappingURL=index.b0ec845e.mjs.map
