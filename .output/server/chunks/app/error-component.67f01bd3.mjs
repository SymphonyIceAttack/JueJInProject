...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = vue_cjs_prod.defineAsyncComponent(() => import('./error-404.3f7d1f03.mjs'));
    const _Error = vue_cjs_prod.defineAsyncComponent(() => import('./error-500.9c37be1f.mjs'));
...
//# sourceMappingURL=error-component.67f01bd3.mjs.map
